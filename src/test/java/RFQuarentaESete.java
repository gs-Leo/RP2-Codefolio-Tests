...
public class RFQuarentaESete {
    ...
    @Test
    @DisplayName("RF47.01 - Iniciar Curso com PIN Correto")
    public void CT47_01_iniciarComPinCorreto() {
        irParaCursos();
        abrirCurso("Curso do pin");
        ...
        assertTrue(abaConteudo.isDisplayed(), "O curso deveria ter iniciado.");
    }

    @Test
    @DisplayName("RF47.02 - Bloqueio ao Iniciar com PIN Incorreto")
    public void CT47_02_tentarIniciarComPinIncorreto() {
        irParaCursos();
        abrirCurso("Curso para Testes");
        ...
        assertTrue(msgErro.isDisplayed(), "Deveria exibir erro de PIN incorreto.");
    }

    @Test
    @DisplayName("RF47.03 - Validação de PIN Vazio ao Iniciar")
    public void CT47_03_tentarIniciarComPinVazio() {
        irParaCursos();
        abrirCurso("Curso para Testes");
